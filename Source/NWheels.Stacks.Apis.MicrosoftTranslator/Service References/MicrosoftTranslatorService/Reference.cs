...
namespace NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslations", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsResponse")]
        System.Threading.Tasks.Task<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.Translation[] translations, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.Translation[] translations, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        System.Threading.Tasks.Task<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        ...
        NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArrayResponse")]
        System.Threading.Tasks.Task<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        ...
        NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2Response")]
        System.Threading.Tasks.Task<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.LanguageService>, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.LanguageService {
        ...
        public NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
            return base.Channel.GetTranslations(appId, text, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.Translation[] translations, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.Translation[] translations, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
            return base.Channel.AddTranslationArrayAsync(appId, translations, from, to, options);
        }
        
        public NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
            return base.Channel.GetTranslationsArray(appId, texts, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
        ...
        public NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArrayAsync(appId, texts, from, to, options);
        }
        
        public NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray2(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, NWheels.Stacks.Apis.MicrosoftTranslator.MicrosoftTranslatorService.TranslateOptions options) {
