...
namespace NWheels.Client
{
    public class TestThreadLogAppender : IThreadLogAppender
    {
        ...
        private readonly ClientSideFramework _framework;
        private readonly ClientSideThreadLog _threadLog;

        //-----------------------------------------------------------------------------------------------------------------------------------------------------

        public TestThreadLogAppender(ClientSideFramework framework)
        {
            _framework = framework;
            _threadLog = new ClientSideThreadLog(framework);
        }
        ...
        private class ClientSideThreadLog : IThreadLog
        {
            private readonly ClientSideFramework _framework;
            ...
            public ClientSideThreadLog(ClientSideFramework framework)
            {
                _framework = framework;
