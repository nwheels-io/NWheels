...
{
    public class ClientEntityObjectFactory : EntityObjectFactory
    {
        public ClientEntityObjectFactory(IComponentContext components, DynamicModule module, TypeMetadataCache metadataCache)
        ...
        protected override IObjectFactoryConvention[] BuildConventionPipeline(ObjectFactoryContext context)
        {
            ...
            return new IObjectFactoryConvention[] {
                ...
                new ClientIdGeneratorConvention(metaType), 
            };
        }
