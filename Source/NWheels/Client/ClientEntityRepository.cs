...
{
    public class ClientEntityRepository<TEntity, TEntityId> : IEntityRepository<TEntity>, IEntityRepository, IQueryable<TEntity>
        where TEntity : class
    {
        ...
        public ClientEntityRepository(IComponentContext components, EntityObjectFactory objectFactory, IDomainObjectFactory domainObjectFactory)
        {
        ...
        public Type PersistableObjectFactoryType
        {
            get
            {
                return typeof(ClientEntityObjectFactory);
            }
        }
