...
namespace NWheels.Processing.Impl
{
    internal abstract class WorkflowCodeBehindAdapter
    {
        ...
        public abstract void OnInitialize(IWorkflowCodeBehind codeBehind, IWorkflowInstanceEntity initialData);
        ...
        where TCodeBehind : class, IWorkflowCodeBehind
    {
        ...
        public override void OnInitialize(IWorkflowCodeBehind codeBehind, IWorkflowInstanceEntity initialData)
        {
            InvokeIf<IInitializableWorkflowCodeBehind<TDataEntity>>(
                codeBehind,
                initializable => {
                    initializable.OnInitialize((TDataEntity)initialData);
                });
        }
