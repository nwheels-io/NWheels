...
namespace NWheels.UI
{
    ...
    public interface IScreenPartPresenter<TInputParam, TContents, TData, TState>
        ...
        where TState : class
    {
        ...
        /// </param>
        void DescribePresenter(IScreenPartPresenterBuilder<TInputParam, TContents, TData, TState> builder);

        //-----------------------------------------------------------------------------------------------------------------------------------------------------

        /// <summary>
        /// The declared contents of the screen part.
        /// </summary>
