...
namespace NWheels.UI
{
    ...
    public interface IScreenPresenter<TInputParam, TContents, TData, TState>
        ...
        where TState : class
    {
        ...
        /// </param>
        void DescribePresenter(IScreenPresenterBuilder<TInputParam, TContents, TData, TState> builder);
    }
}
