...
{
    public interface ITypeFactoryMechanism
    {
        ITypeKey CreateKey<TKeyExtension>(Type primaryContract, Type[] secondaryContracts, TKeyExtension extension);
        ...
        ITypeFactoryProduct GetOrBuildProduct(ITypeKey key);
    ...
    public class BuildingNewTypeEventArgs : EventArgs
    {
        ...
        public ITypeKey Key { get; private set; }
