...
{
    public class LazyLoadObjectCollectionByInverseForeignKeyPropertyStrategy : PropertyImplementationStrategy
    {
        ...
        public LazyLoadObjectCollectionByInverseForeignKeyPropertyStrategy(
        ...
        protected override void OnWritingExportStorageValue(MethodWriterBase writer, Operand<IEntityRepository> entityRepo, Operand<object[]> valueVector)
        {
            valueVector.ItemAt(MetaProperty.PropertyIndex).Assign(
                writer.New<ObjectCollectionLazyLoaderByForeignKey>(
