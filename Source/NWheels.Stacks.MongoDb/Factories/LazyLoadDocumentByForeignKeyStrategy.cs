...
{
    public class LazyLoadDocumentByForeignKeyStrategy : PropertyImplementationStrategy
    {
        public LazyLoadDocumentByForeignKeyStrategy(ObjectFactoryContext factoryContext, ITypeMetadataCache metadataCache, ITypeMetadata metaType, IPropertyMetadata metaProperty)
